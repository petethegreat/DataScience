...
## Caret
Caret is a wrapper around a bunch of different machine learning packages. It allows many different machine learning packages to be utilised through the same interface.
